...
// negative: GET request for non-existent order ID — expect status 400
...
// positive: update an existing order using valid data and correct API key — expect status 200
...
// negative: update an order with invalid data (missing required fields) — expect status 400
...
// negative: update an order using invalid API key — expect status 401 (Unauthorized)
...
// positive: delete an existing order using valid API key — expect status 204
...
// negative: delete a non-existent order with ID = 0 — expect status 400
...
// negative: delete a non-existent order with ID = 999999 — expect status 400
